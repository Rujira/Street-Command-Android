...
public class ThaiSmartCard {
    ...
    private SmartCardMessage.DataBlock getCardData(byte[] requestMessage) {
        ...
        //Log.w(TAG, "getCardData(byte[] requestMessage)");
...
//        }
        ...
        try {
            String tmpNameTH = new String(nameTHBuffer, "TIS620");
            String tmpNameEN = new String(nameENBuffer, "TIS620");

            tmpNameTH = tmpNameTH.replace("##", "#");
            String[] arrOfNameTH = tmpNameTH.split("#");
            tmpNameTH = arrOfNameTH[1] + " " + arrOfNameTH[2];

            tmpNameEN = tmpNameEN.replace("##", "#");
            String[] arrOfNameEN = tmpNameEN.split("#");
            tmpNameEN = arrOfNameEN[1] + " " + arrOfNameEN[2];
            ...
            personalInformation.NameTH = tmpNameTH;
            personalInformation.NameEN = tmpNameEN;
            ...
            personalInformation.Gender = String.format("%s", new String(Arrays.copyOfRange(buffer, 225, 226), "TIS620"));
